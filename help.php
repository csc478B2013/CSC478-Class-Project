...
<div class="container">
    <div class="grid">
        <div class="row">
			...
			<img src="images/help/initScreenOfSite.gif"><br/><br/>
			...
			<p><strong>Step 3:</strong>  Once you are done filling out the information on the New User Setup page click the Add button to be taken to the next screen.</p>
			...
			<p><strong>Step 5:</strong>  Once you are done filling out the information on the New User Questionnaire page click the Create button to be taken to the next screen.</p>
			...
			<p><strong>Step 7:</strong>  Once you are done filling out the information on the Add Semester page click the Add button to be taken to the next screen.</p>
			...
			<p><strong>What do the Buttons Mean?</p></strong>	
			<ol>
			...
			<p><strong>Step 9:</strong>   When you are done adding your courses, and then click the Add Assignment button to start adding assignments to your various courses.</p>
			...
			<img src="images/help/currentSemesterExpanded.gif"><br/><br/>
			
			<p><strong>History In Detail</p></strong>
			...
			<img src="images/help/historyMain.gif"><br/><br/>
		...
		<p><strong>What do the Fields Mean?</strong></p> 
			...
			<p><strong>Deleting a Semester</p></strong>
			...
			<img src="images/help/removeSemester.gif"><br/><br/>
			
			
			<p><strong>Modify a Course In Detail</p></strong>
			<p>Under the Course listing in the Modify menu you can either add or delete a course.</p>

			<p><strong>Adding a Course</p></strong>
			...
			<p><strong>Deleting a Course</p></strong>
			...
			<img src="images/help/removeCourse.gif"><br/><br/>
			
			<p><strong>Modify an Assignment In Detail</p></strong>
			<p>Under the Assignment listing in the Modify menu you can either add or delete an assignment or update the score on that assignment.</p>

			<p><strong>Adding an Assignment</p></strong>
			...
			<p><strong>Deleting an Assignment</p></strong>
			...
			<img src="images/help/removeAssignment.gif"><br/><br/>
			<p><strong>Updating the score on an Assignment</p></strong>
			...
			<img src="images/help/updateAssignmentScore.gif"><br/><br/>

			<p><strong>Updating Your Account Information</p></strong>
			<p>To update your account information, make sure that you are logged in, click the gear icon in the upper right corner of MyUPlan and click the Account link. When you click the Account link you are taken to the Update Student Settings page and from here you can update your account.</p>

			<p><strong>Update User Settings</p></strong>
			...
			[MISSING UPDATE USER STUDY SETTINGS]
