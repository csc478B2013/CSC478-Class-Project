...
<div class="container">
    <div class="grid">
        ...
        <?php
			...
			for($test = 0; $test < 10; $test++) { 	// cycle through all of the tests
				...
				switch($test) {
					...
					case 1: {		// Insert Test
						...
						Student::insert($link, 'Stephen', 'stephen@gmail.com', '999-888-7777', 'password123');
							...
							Semester::insert($link, 1, 2014, 'Fall', '2014-08-01', '2014-12-25');
						...
						Student::insert($link, 'Joe', 'joe@gmail.com', '111-222-3333', '123password');
							Semester::insert($link, 2, 2014, 'Spring', '2014-01-01', '2014-05-25');
							...
							Semester::insert($link, 2, 2014, 'Fall', '2014-08-01', '2014-12-25');
